...
echo "roslaunch anfis_rl multi_simulation.launch -p "$1" "ns:=$2""
/usr/bin/python2 /opt/ros/melodic/bin/roslaunch $HOME'/catkin_ws/src/anfis_rl/launch/multi_simulation.launch' -p "$1" "ns:=$2"
exit 0
